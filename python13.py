...
for items in inputSentence:
  if items.isalpha():  #function which give possibility to check if current item is a letter 
    countsOfLetters += 1
  elif items.isdigit():  #function which give possibility to check if current item is digit 
    countsOfDigits +=1
  else:
    pass  #I need to add the else statement but I didn't have any sentence to use here, that's why I used  the pass statement

print(" LETTERS ", countsOfLetters, "\n", "DIGITS ", countsOfDigits)
